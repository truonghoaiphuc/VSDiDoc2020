...
{
    public partial class FrmNguoiDung : FrmBase
    {
        DATA.NguoiDungRow _nguoidung;
   
        public FrmNguoiDung(DATA.NguoiDungRow nguoidung)
        {
            InitializeComponent();
            ...
            txtMatKhau.Binding(_nguoidung, "MatKhau");
        ...
        protected override bool OnSave()
        {
            ...
            {
                txtXacNhan.ErrorText = "Xác nhận mật khẩu không khớp";
                return false;
            }
            ...
            try
            {
                _nguoidung.MatKhau = HeThong.MaHoaMD5(txtMatKhau.Text);
