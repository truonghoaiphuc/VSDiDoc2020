...
{
    public class LotusEncoding
    {
        /// <summary>
        /// nguonvietvn
        /// </summary>
        public const string INIT_VECTOR_ENCRYPT_DECRYPT = "nhan@nguonvietvn"; // must be 16 bytes

        public LotusEncoding()
        {
    ...
    public class RijndaelEnhanced
    {
        ...
        {
            return EncryptToBytes(System.Text.Encoding.UTF8.GetBytes(plainText));
        }
