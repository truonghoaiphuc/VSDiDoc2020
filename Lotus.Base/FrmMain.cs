...
namespace Lotus.Base
{
    public partial class FrmMain : RibbonForm
    {
                    ...
                    foreach (RibbonPageGroup group in page.Groups)
                    {
                        ...
                        foreach (BarItemLink itemlink in group.ItemLinks)
                        {
                            ...
                            if (HeThong.NguoiDungDangNhap != null)
                            {
                                ...
                                itemlink.Visible = quyenItem.TruyCap;

                                if (quyenItem.TruyCap)
                                {
                                    group.Visible = true;
                                    page.Visible = true;
                                }
        ...
        //<summary>
        //Ẩn các chức năng chưa được phân quyền
        //</summary>
        public void InitMenu()
        {
            foreach (RibbonPage page in ribbon.Pages)
            {
                ...
                foreach (RibbonPageGroup group in page.Groups)
                {
                    foreach (BarItemLink itemlink in group.ItemLinks)
                    {
                        //if (itemlink.Item.Equals(b)) continue;
                        //if (itemlink.Item.Equals(btnChangePWD)) continue;
                        //if (itemlink.Item.Equals(btnClean)) continue;
